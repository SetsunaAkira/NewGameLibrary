...
namespace Debug
{
	...
	extern "C"
	{
		...
		ENGINE_API void DrawaCross(const Vector2D& v1, const Vector2D& size, const Color& color = Color::red);
#ifdef __cplusplus
	}
#endif
}
	...
	#define DEBUG_DRAW_CROSS(v1, size, color) Debug::DrawaCross(v1,size,color);
#else
